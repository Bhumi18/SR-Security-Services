...
const sections = [
  {
    ...
    p: "We collect only the details you choose to submit through our enquiry, quotation, careers or newsletter forms — typically your name, organisation, phone number, email address, site location and requirement description.",
  },
  {
